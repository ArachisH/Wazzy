...
namespace Wazzy.Bytecode
{
    public abstract class WASMInstruction : WASMObject
    {
        ...
        public static WASMInstruction Create(OPCode op, WASMReader input = null) => op switch
        {
            ...
            OPCode.ConstantFloat64 => new ConstantFloat64Ins(input),
            ...
            OPCode.Int64ExtendSInt32 => new Int64ExtendSInt32Ins(),
            OPCode.AddInt64 => new AddInt64Ins(),
            OPCode.GreaterThanOrEqualUInt32 => new GreaterThanOrEqualUInt32Ins(),
            OPCode.LessThanOrEqualUInt32 => new LessThanOrEqualUInt32Ins(),
            OPCode.DivideSInt32 => new DivideSInt32Ins(),
            OPCode.GreaterThanFloat32 => new GreaterThanFloat32Ins(),
            OPCode.LessThanFloat32 => new LessThanFloat32Ins(),
            OPCode.Float32ConvertSInt32 => new Float32ConvertSInt32Ins(),
            OPCode.Int32ReinterpretFloat32 => new Int32ReinterpretFloat32Ins(),
            OPCode.Float32ReinterpretInt32 => new Float32ReinterpretInt32Ins(),
            OPCode.ShiftRightUInt64 => new ShiftRightUInt64Ins(),
            OPCode.Int64ExtendUInt32 => new Int64ExtendUInt32Ins(),
            OPCode.ShiftLeftInt64 => new ShiftLeftInt64Ins(),
            OPCode.AndInt64 => new AndInt64Ins(),
            OPCode.OrInt64 => new OrInt64Ins(),
            OPCode.SquareRootFloat32 => new SquareRootFloat32Ins(),
            OPCode.DivideFloat32 => new DivideFloat32Ins(),
            OPCode.ShiftRightSInt32 => new ShiftRightSInt32Ins(),
            OPCode.NotEqualFloat32 => new NotEqualFloat32Ins(),
            OPCode.AbsoluteFloat32 => new AbsoluteFloat32Ins(),
            OPCode.RemainderUInt32 => new RemainderUInt32Ins(),
            OPCode.RotateLeftInt64 => new RotateLeftInt64Ins(),
            OPCode.SubtractInt64 => new SubtractInt64Ins(),
            ...
            OPCode.LoadInt64_8S => new LoadInt648SIns(input),
